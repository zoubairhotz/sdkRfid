...
//		return super.onCreateOptionsMenu(menu);
    ...
    public void afficherData() {
        ...
        // Assuming `epcTidUser` is an ArrayList of strings
        ArrayList<String> dataList = uhfReadTagFragment.epcTidUser;
        ...
        // File name
        File file = new File(dir, "epcTidUserData.txt");
        ...
        try (FileWriter writer = new FileWriter(file)) {
            ...
            Toast.makeText(BaseTabFragmentActivity.this, "File exported successfully: " + file.getAbsolutePath(), Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            Toast.makeText(BaseTabFragmentActivity.this, "Error exporting file: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
    }
